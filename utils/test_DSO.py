...
def calc_scale(gt_file="gt.txt", est_file="est.txt"):
    ...
    with open("test_DSO_results.txt", "w") as f:
    ...
    #ax.set_xlabel('[m]')
    #ax.set_ylabel('[m]')
    ax.set_title('Trjektorie GT vs. DSO Estimated')
    ax.grid(True)
    ax.axis('equal')
    ax.legend()
    plt.savefig("test_DSO.png")
...
calc_scale("/home/tore/Volume/640x480_norot_noh/gt.txt", "/home/tore/Volume/github/dso/result.txt")
