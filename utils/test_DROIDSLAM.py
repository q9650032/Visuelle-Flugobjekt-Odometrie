...
def calc_scale(gt_file="gt.txt", est_file="est.txt"):
    ...
    with open("test_DROIDSLAM_results.txt", "w") as f:
    ...
    #ax.set_xlabel('[m]')
    #ax.set_ylabel('[m]')
    ax.set_title('Trjektorie GT vs. DROID-SLAM Estimated')
    ax.grid(True)
    ax.axis('equal')
    ax.legend()
    plt.savefig("test_DROIDSLAM.png")

    plt.show()
    plt.close()


calc_scale("/home/tore/Volume/1000x1000_droidtest3/gt.txt", "/home/tore/Volume/github/DROID-SLAM/est_droid_1000x1000.txt")
