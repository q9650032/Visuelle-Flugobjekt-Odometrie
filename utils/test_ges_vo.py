...
def calc_scale(gt_file="gt.txt", est_file="est.txt"):
    ...
    #ax.set_xlabel('[m]')
    #ax.set_ylabel('[m]')
    ax.set_title('Trjektorie GT vs. GES Estimated')
    ax.grid(True)
    ax.axis('equal')
    ax.legend()
    plt.savefig("test_GES.png")
...
calc_scale("/home/tore/Volume/1000x1000_droidtest3/gt.txt", "/home/tore/Volume/github/q9650032/Visuelle-Flugobjekt-Odometrie/ges_homography_est.txt")
